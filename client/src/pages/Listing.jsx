            ...
            <div>
                ...
                <div className="flex flex-col max-w-4xl mx-auto my-7 p-3 gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        {
                            listing.offer && (
                                <p className="bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md">${(+listing.regularPrice - +listing.discountPrice).toLocaleString('en-US')} OFF</p>
                            )
                        }
                    </div>
